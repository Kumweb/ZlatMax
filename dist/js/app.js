(() => {
    ...
    (() => {
        ...
        function rangeInit() {
                    ...
                    input.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.which) {
                          ...
                          case 38:
                            ...
                            if (null !== position) item.noUiSlider.setHandle(handle, value + position);
                            break;
            ...
            if (rangeItemsTwo.length) rangeItemsTwo.forEach((rangeItemTwo => {
        ...
        if (menuBlocks.length) menuBlocks.forEach((menuBlocks => {
